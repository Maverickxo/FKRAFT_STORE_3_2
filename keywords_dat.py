...
/dice: Кубики
/dice_info X (list/win): Список бросили/победителей
...
/sale on_off: Включение и выключение распродажи
...
Управление купонами:
/coop: Проверка выходных купонов 
/count_cup X: Узнать количество купонов с X скидкой 
...
/speakcl: Очистка медиа для рассылки
/response_store: Ответ на вопрос в магазин
/speak_store: Рассылка всем в магазине
/speak_chat: Отправка от имени бота репутации
...
INFO = """
🛍️ *KRAFT STORE BOT - версия 4.7.3222* 🛍️
